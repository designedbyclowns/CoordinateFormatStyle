...
extension FormatStyle where Self == CLLocationDegrees.DegreesMinutesSecondsFormatStyle {
    public static var degreesMinutesSeconds:  CLLocationDegrees.DegreesMinutesSecondsFormatStyle { .init() }
}

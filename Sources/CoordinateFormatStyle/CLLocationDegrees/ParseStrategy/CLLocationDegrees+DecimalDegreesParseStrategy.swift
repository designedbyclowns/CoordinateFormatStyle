...
extension ParseStrategy where Self == CLLocationDegrees.DecimalDegreesParseStrategy {
    public static var decimalDegrees:  CLLocationDegrees.DecimalDegreesParseStrategy { .init() }
}

extension CLLocationDegrees.DecimalDegreesFormatStyle: ParseableFormatStyle {
    public var parseStrategy: CLLocationDegrees.DecimalDegreesParseStrategy {
        .init()
    }
}

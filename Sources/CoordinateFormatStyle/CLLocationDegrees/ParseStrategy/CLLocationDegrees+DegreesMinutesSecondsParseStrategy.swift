...
extension ParseStrategy where Self == CLLocationDegrees.DegreesMinutesSecondsParseStrategy {
    public static var degreesMinutesSeconds:  CLLocationDegrees.DegreesMinutesSecondsParseStrategy { .init() }
}

extension CLLocationDegrees.DegreesMinutesSecondsFormatStyle : ParseableFormatStyle {
    public var parseStrategy: CLLocationDegrees.DegreesMinutesSecondsParseStrategy {
        .init()
    }
}

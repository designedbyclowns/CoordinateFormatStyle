...
/// UTMCoordinate parse strategy.
public typealias UTMCoordinateParseStrategy = UTMCoordinate.ParseStrategy
...
public extension UTMCoordinate {
    ...
    struct ParseStrategy : Foundation.ParseStrategy {
        ...
        /// Creates a new `UTMCoordinate` by parsing the formatted string.
        public func parse(_ value: String) throws(ParsingError) -> UTMCoordinate {

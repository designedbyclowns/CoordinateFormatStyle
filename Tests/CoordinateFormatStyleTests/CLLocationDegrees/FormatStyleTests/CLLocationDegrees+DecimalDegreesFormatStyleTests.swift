...
struct CLLocationDegrees_DecimalDegreesFormatStyleTests {
    ...
    @Test func defaultArguments() {
        #expect(CLLocationDegrees(90.0).formatted(formatStyle) == "90.0°")
        #expect(CLLocationDegrees(-90.0).formatted(formatStyle) == "-90.0°")
        #expect(CLLocationDegrees(90.01).formatted(formatStyle) == "90.01°")
        #expect(CLLocationDegrees(-90.01).formatted(formatStyle) == "-90.01°")
        
        #expect(CLLocationDegrees(180.0).formatted(formatStyle) == "180.0°")
        #expect(CLLocationDegrees(-180.0).formatted(formatStyle) == "-180.0°")

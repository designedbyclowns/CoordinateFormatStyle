...
struct CLLocationDegrees_FormatStyle_DegreesMinutesSeconds_Tests {
    let formatStyle = CLLocationDegrees.FormatStyle.DegreesMinutesSeconds()
    
    @Test func defaultArguments() {
        #expect(CLLocationDegrees(90.0).formatted(formatStyle) == "90° 0′ 0″ E")
        #expect(CLLocationDegrees(-90.0).formatted(formatStyle) == "90° 0′ 0″ W")
        #expect(CLLocationDegrees(90.01).formatted(formatStyle) ==  "90° 0′ 36″ E")
        #expect(CLLocationDegrees(-90.01).formatted(formatStyle) == "90° 0′ 36″ W")
        
        #expect(CLLocationDegrees(180.0).formatted(formatStyle) == "180° 0′ 0″ E")
        #expect(CLLocationDegrees(-180.0).formatted(formatStyle) == "180° 0′ 0″ W")

...
struct CLLocationDegrees_DegreesDecimalMinutesFormatStyleTests {
    let formatStyle = CLLocationDegrees.DegreesDecimalMinutesFormatStyle()
    
    @Test func defaultArguments() {
        #expect(CLLocationDegrees(90.0).formatted(formatStyle) == "90° 00.000'")
        #expect(CLLocationDegrees(-90.0).formatted(formatStyle) == "-90° 00.000'")
        #expect(CLLocationDegrees(90.01).formatted(formatStyle) == "90° 00.600'")
        #expect(CLLocationDegrees(-90.01).formatted(formatStyle) == "-90° 00.600'")
        
        #expect(CLLocationDegrees(180.0).formatted(formatStyle) == "180° 00.000'")
        #expect(CLLocationDegrees(-180.0).formatted(formatStyle) == "-180° 00.000'")
